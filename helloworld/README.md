...
## Level 1 deployment summary

This repository includes a working preview deployment of the hello-world contract.

- Network: `preview`
- Contract address: `d032a5edce605d3dad84033dd79227f4873c633e455ae98ff856a1cad0f3786e`
- Deployer wallet: `mn_addr_preview1rtgjts69x9ms4ec6suf6m4p5lw46cpcdlwq4u86chatwf4k09lmqsekrkl`
- Wallet seed persisted for replay: `d6cd19bdfab370dab47d41e07bf2f34bae79f60c0a61e761c03db0de51fb5c58`
- Deployment timestamp: `2026-08-04T17:34:09.862Z`

Reproduce locally from WSL or a Linux shell:

```bash
cd /mnt/d/SY/Stellar/IntoTheMidnight-SPPU/helloworld
npm install
MIDNIGHT_FAUCET_TIMEOUT_MS=1800000 npm run setup -- --network preview
```

If the preview faucet is slow, the deploy script will wait for funded tNIGHT and continue automatically once the balance arrives.
